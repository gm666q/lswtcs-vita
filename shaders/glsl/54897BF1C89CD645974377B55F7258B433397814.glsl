//SharedShaders/0xa41b6793.ios_vcode uklgonzale Wed Mar 12 20:06:47 2014
 ...
 void main()
{
    ...
    _b0106 = _TMP0 - float(_fog_params.x);
    _TMP1 = max(0.00000000E+000, _b0106);
    _dist = float(_TMP1);
    _a0108 = _dist/_fog_params.z;
    _TMP4 = min(float(_a0108), 1.00000000E+000);
    _TMP2 = float(_TMP4);
