//SharedShaders/0x4c3851c4.ios_pcode uklgonzale Wed Mar 12 17:37:59 2014
 ...
 void main()
{
    ...
    _colorLayer10139.w = _colorLayer10139.w*_layer_kOpacities.y;
    _TMP950145 = _colorLayer00139.xyz*(_colorLayer10139.xyz*_colorLayer10139.w + vec3(1.00000000E+000 - _colorLayer10139.w, 1.00000000E+000 - _colorLayer10139.w, 1.00000000E+000 - _colorLayer10139.w));
    _TMP144 = vec4(_TMP950145.x, _TMP950145.y, _TMP950145.z, _colorLayer00139.w);
    ...
    _colorLayer20139.w = _colorLayer20139.w*_layer_kOpacities.z;
    _TMP970149 = _TMP144.xyz + _colorLayer20139.xyz*_colorLayer20139.w;
    _TMP148 = vec4(_TMP970149.x, _TMP970149.y, _TMP970149.z, _TMP144.w);
