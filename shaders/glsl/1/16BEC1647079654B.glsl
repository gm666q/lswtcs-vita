//SharedShaders/0x138ac84c.ios_vcode uklgonzale Tue Mar 11 16:25:13 2014
 ...
 void main()
{
    ...
    _TMP830091[0] = vec3(float(_TMP123.x), float(_TMP124.y), float(_TMP125.z));
    _TMP126.x = _TMP11[1].x;
    _TMP127.y = _TMP11[1].y;
    _TMP128.z = _TMP11[1].z;
    _TMP830091[1] = vec3(float(_TMP126.x), float(_TMP127.y), float(_TMP128.z));
    _TMP129.x = _TMP11[2].x;
    _TMP130.y = _TMP11[2].y;
    _TMP131.z = _TMP11[2].z;
    _TMP830091[2] = vec3(float(_TMP129.x), float(_TMP130.y), float(_TMP131.z));
