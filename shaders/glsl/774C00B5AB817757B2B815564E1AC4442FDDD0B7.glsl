//SharedShaders/0xfcc8495a.ios_vcode uklgonzale Wed Mar 12 14:37:38 2014
 ...
 void main()
{
    ...
    _TMP810089[0] = vec3(float(_TMP124.x), float(_TMP125.y), float(_TMP126.z));
    _TMP127.x = _TMP11[1].x;
    _TMP128.y = _TMP11[1].y;
    _TMP129.z = _TMP11[1].z;
    _TMP810089[1] = vec3(float(_TMP127.x), float(_TMP128.y), float(_TMP129.z));
    _TMP130.x = _TMP11[2].x;
    _TMP131.y = _TMP11[2].y;
    _TMP132.z = _TMP11[2].z;
    _TMP810089[2] = vec3(float(_TMP130.x), float(_TMP131.y), float(_TMP132.z));
