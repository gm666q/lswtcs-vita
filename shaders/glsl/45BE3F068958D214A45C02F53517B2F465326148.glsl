//SharedShaders/0x7f6bbce3.ios_pcode uklgonzale Wed Mar 12 18:52:39 2014
 ...
 void main()
{
    ...
    _TMP7._color[0] = vec4(float(_TMP89.x), float(_TMP89.y), float(_TMP89.z), float(_TMP89.w));
    _falloff0094 = float(_input1._texcoord1);
    _b0096 = vec3(float(_TMP7._color[0].x), float(_TMP7._color[0].y), float(_TMP7._color[0].z));
    _TMP3 = _fog_color.xyz + _falloff0094*(_b0096 - _fog_color.xyz);
