//C:\sagadata\SharedShaders/0xfcc8495a.ios_pcode ukjbell Wed Nov 13 18:11:03 2013
 ...
 void main()
{
    ...
    _TMP13 = float(_TMP14);
    _reflection0110 = _TMP28 - (2.00000000E+000*_TMP26)*_TMP13;
    _v0116 = vec3(float(_reflection0110.x), float(_reflection0110.y), float(_reflection0110.z));
    _TMP146.x = _vs_view[0].x;
    _TMP146.y = _vs_view[0].y;
    _TMP146.z = _vs_view[0].z;
    _r0116.x = dot(_TMP146, _v0116);
    _TMP147.x = _vs_view[1].x;
    _TMP147.y = _vs_view[1].y;
    _TMP147.z = _vs_view[1].z;
    _r0116.y = dot(_TMP147, _v0116);
    _TMP148.x = _vs_view[2].x;
    _TMP148.y = _vs_view[2].y;
    _TMP148.z = _vs_view[2].z;
    _r0116.z = dot(_TMP148, _v0116);
    _TMP27 = vec3(float((-_r0116).x), float((-_r0116).y), float((-_r0116).z));
    ...
    if (cg_TexCoord3.x <= 0.00000000E+000) {         _diffuseLight0131 = vec3( 1.00000000E+000, 1.00000000E+000, 1.00000000E+000);
    ...
    _c0139 = vec3(float(_TMP27.x), float(_TMP27.y), float(_TMP27.z));
    ...
    _falloff0142 = float(_input1._texcoord4);
    ...
    _c0145 = _TMP18._color[0].w*float(_alphaTestParameters.x) - float(_alphaTestParameters.y);
    if (_c0145 < 0.00000000E+000) {         discard;
