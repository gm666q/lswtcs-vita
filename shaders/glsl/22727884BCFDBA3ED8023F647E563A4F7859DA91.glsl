//SharedShaders/0xc92393d0.ios_vcode uklgonzale Wed Mar 12 17:13:27 2014
 ...
 void main()
{
    ...
    _TMP850093[0] = vec3(float(_TMP136.x), float(_TMP137.y), float(_TMP138.z));
    _TMP139.x = _TMP17[1].x;
    _TMP140.y = _TMP17[1].y;
    _TMP141.z = _TMP17[1].z;
    _TMP850093[1] = vec3(float(_TMP139.x), float(_TMP140.y), float(_TMP141.z));
    _TMP142.x = _TMP17[2].x;
    _TMP143.y = _TMP17[2].y;
    _TMP144.z = _TMP17[2].z;
    _TMP850093[2] = vec3(float(_TMP142.x), float(_TMP143.y), float(_TMP144.z));
