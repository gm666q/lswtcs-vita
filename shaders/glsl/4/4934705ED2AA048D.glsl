//C:\sagadata\SharedShaders/0x90f749d2.ios_pcode ukjbell Wed Nov 13 18:08:18 2013
 ...
 void main()
{
    ...
    _TMP16._color[0] = vec4(float(_colorLayer00118.x), float(_colorLayer00118.y), float(_colorLayer00118.z), float(_colorLayer00118.w));
    ...
    _finalLightingFactor0127 = (1.00000000E+000 - _envmap_params.x) + _envmap_params.xxx;
    ...
    _TMP16._color[0].xyz = _TMP16._color[0].xyz + vec3(float((_result0122.xyz*_TMP1).x), float((_result0122.xyz*_TMP1).y), float((_result0122.xyz*_TMP1).z));
