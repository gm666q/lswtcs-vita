//SharedShaders/0x0bd0d2ca.ios_pcode uklgonzale Tue Mar 11 16:25:40 2014
 ...
 void main()
{
    ...
    _TMP12 = dot(vec3(float(_vs_lightPosition0.x), float(_vs_lightPosition0.y), float(_vs_lightPosition0.z)), vec3(float(_TMP32.x), float(_TMP32.y), float(_TMP32.z)));
    _TMP4 = float(_TMP12);
    _TMP13 = max(0.00000000E+000, float(_TMP4));
    _TMP5 = float(_TMP13);
    _TMP34 = _TMP5*_vs_lightPosition0.w;
    _TMP12 = dot(vec3(float(_vs_lightPosition1.x), float(_vs_lightPosition1.y), float(_vs_lightPosition1.z)), vec3(float(_TMP32.x), float(_TMP32.y), float(_TMP32.z)));
    _TMP6 = float(_TMP12);
    _TMP13 = max(0.00000000E+000, float(_TMP6));
    _TMP7 = float(_TMP13);
    _TMP35 = _TMP7*_vs_lightPosition1.w;
    _diffuseLight0136 = _TMP34*_vs_lightColor0.xyz;
    _diffuseLight0136 = _diffuseLight0136 + _TMP35*_vs_lightColor1.xyz;
    _i0140 = -_averageLightDir.xyz;
    _TMP12 = dot(vec3(float(_TMP32.x), float(_TMP32.y), float(_TMP32.z)), vec3(float(_i0140.x), float(_i0140.y), float(_i0140.z)));
    _TMP17 = float(_TMP12);
    _R20138 = _i0140 - (2.00000000E+000*_TMP32)*_TMP17;
    _TMP12 = dot(vec3(float(_TMP33.x), float(_TMP33.y), float(_TMP33.z)), vec3(float(_R20138.x), float(_R20138.y), float(_R20138.z)));
    _TMP14 = float(_TMP12);
