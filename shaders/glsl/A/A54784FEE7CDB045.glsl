//SharedShaders/0x25d47953.ios_pcode uklgonzale Wed Mar 12 20:12:06 2014
 ...
 void main()
{
    ...
    _colorLayer10094.w = _colorLayer10094.w*_layer_kOpacities.y;
    ...
    _colorLayer20094.w = _colorLayer20094.w*_layer_kOpacities.z;
