//SharedShaders/0x4d1ccfb5.ios_pcode uklgonzale Wed Mar 12 16:48:12 2014
 ...
 void main()
{
    ...
    _TMP12 = float(_TMP13);
    _reflection0105 = _TMP26 - (2.00000000E+000*_TMP24)*_TMP12;
    _v0111 = vec3(float(_reflection0105.x), float(_reflection0105.y), float(_reflection0105.z));
    _TMP139.x = _vs_view[0].x;
    _TMP139.y = _vs_view[0].y;
    _TMP139.z = _vs_view[0].z;
    _r0111.x = dot(_TMP139, _v0111);
    _TMP140.x = _vs_view[1].x;
    _TMP140.y = _vs_view[1].y;
    _TMP140.z = _vs_view[1].z;
    _r0111.y = dot(_TMP140, _v0111);
    _TMP141.x = _vs_view[2].x;
    _TMP141.y = _vs_view[2].y;
    _TMP141.z = _vs_view[2].z;
    _r0111.z = dot(_TMP141, _v0111);
    _TMP25 = vec3(float((-_r0111).x), float((-_r0111).y), float((-_r0111).z));
    ...
    _c0132 = vec3(float(_TMP25.x), float(_TMP25.y), float(_TMP25.z));
    ...
    _falloff0135 = float(_input1._texcoord3);
    ...
    _c0138 = _TMP17._color[0].w*float(_alphaTestParameters.x) - float(_alphaTestParameters.y);
    if (_c0138 < 0.00000000E+000) {         discard;
