//SharedShaders/0x53ba5fc4.ios_pcode uklgonzale Wed Mar 12 19:59:31 2014
 ...
 void main()
{
    ...
    _colorLayer10095.w = _colorLayer10095.w*_layer_kOpacities.y;
    ...
    _colorLayer20095.w = _colorLayer20095.w*_layer_kOpacities.z;
