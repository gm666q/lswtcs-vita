//SharedShaders/0x0053a291.ios_vcode uklgonzale Wed Mar 12 14:33:26 2014
 ...
 void main()
{
    ...
    _TMP780086[0] = vec3(float(_TMP117.x), float(_TMP118.y), float(_TMP119.z));
    _TMP120.x = _TMP11[1].x;
    _TMP121.y = _TMP11[1].y;
    _TMP122.z = _TMP11[1].z;
    _TMP780086[1] = vec3(float(_TMP120.x), float(_TMP121.y), float(_TMP122.z));
    _TMP123.x = _TMP11[2].x;
    _TMP124.y = _TMP11[2].y;
    _TMP125.z = _TMP11[2].z;
    _TMP780086[2] = vec3(float(_TMP123.x), float(_TMP124.y), float(_TMP125.z));
