//C:\sagadata\SharedShaders/0x3b167516.ios_pcode ukjbell Wed Nov 13 18:08:51 2013
 ...
 void main()
{
    ...
    _result0122 = vec4(_specular_specular.x, _specular_specular.y, _specular_specular.z, 1.00000000E+000);
    ...
    _diffuseLight0135 = _TMP33*_vs_lightColor0.xyz;
    _diffuseLight0135 = _diffuseLight0135 + _TMP34*_vs_lightColor1.xyz;
    ...
    _diffuseLight0135 = _diffuseLight0135 + _ambientColor.xyz + _vs_sceneAmbientColor.xyz;
    _diffuseLight0135 = _diffuseLight0135 + _incandescentGlow.xyz*(vec3( 1.00000000E+000, 1.00000000E+000, 1.00000000E+000) - _diffuseLight0135);
    _specularLight0151 = _TMP8*_result0122.xyz;
    _TMP910151 = _colorLayer00118.xyz*_diffuseLight0135 + _specularLight0151;
