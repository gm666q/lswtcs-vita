//SharedShaders/0x7d14d0e0.ios_pcode uklgonzale Tue Mar 11 16:25:25 2014
 ...
 void main()
{
    ...
    _TMP1 = _TMP10*_v0093;
    _TMP31 = vec3(float(_TMP1.x), float(_TMP1.y), float(_TMP1.z));
    ...
    _TMP11 = dot(vec3(float(_vs_lightPosition0.x), float(_vs_lightPosition0.y), float(_vs_lightPosition0.z)), vec3(float(_TMP30.x), float(_TMP30.y), float(_TMP30.z)));
    _TMP3 = float(_TMP11);
    _TMP12 = max(0.00000000E+000, float(_TMP3));
    _TMP4 = float(_TMP12);
    _TMP32 = _TMP4*_vs_lightPosition0.w;
    _TMP11 = dot(vec3(float(_vs_lightPosition1.x), float(_vs_lightPosition1.y), float(_vs_lightPosition1.z)), vec3(float(_TMP30.x), float(_TMP30.y), float(_TMP30.z)));
    _TMP5 = float(_TMP11);
    _TMP12 = max(0.00000000E+000, float(_TMP5));
    _TMP6 = float(_TMP12);
    _TMP33 = _TMP6*_vs_lightPosition1.w;
    _diffuseLight0130 = _TMP32*_vs_lightColor0.xyz;
    _diffuseLight0130 = _diffuseLight0130 + _TMP33*_vs_lightColor1.xyz;
    _i0134 = -_averageLightDir.xyz;
    _TMP11 = dot(vec3(float(_TMP30.x), float(_TMP30.y), float(_TMP30.z)), vec3(float(_i0134.x), float(_i0134.y), float(_i0134.z)));
    _TMP16 = float(_TMP11);
    _R20132 = _i0134 - (2.00000000E+000*_TMP30)*_TMP16;
    _TMP11 = dot(vec3(float(_TMP31.x), float(_TMP31.y), float(_TMP31.z)), vec3(float(_R20132.x), float(_R20132.y), float(_R20132.z)));
    _TMP13 = float(_TMP11);
