//SharedShaders/0x4c3851c4.ios_vcode uklgonzale Wed Mar 12 17:37:58 2014
 ...
 void main()
{
    ...
    _TMP129.x = _TMP11[0].x;
    _TMP130.y = _TMP11[0].y;
    _TMP131.z = _TMP11[0].z;
    _TMP860094[0] = vec3(float(_TMP129.x), float(_TMP130.y), float(_TMP131.z));
    _TMP132.x = _TMP11[1].x;
    _TMP133.y = _TMP11[1].y;
    _TMP134.z = _TMP11[1].z;
    _TMP860094[1] = vec3(float(_TMP132.x), float(_TMP133.y), float(_TMP134.z));
    _TMP135.x = _TMP11[2].x;
    _TMP136.y = _TMP11[2].y;
    _TMP137.z = _TMP11[2].z;
    _TMP860094[2] = vec3(float(_TMP135.x), float(_TMP136.y), float(_TMP137.z));
    ...
    _TMP4 = min(float(_a0128), 1.00000000E+000);
    _TMP2 = float(_TMP4);
