//SharedShaders/0x3b699a57.ios_vcode uklgonzale Wed Mar 12 18:56:13 2014
 ...
 void main()
{
    ...
    _objectPosition0091 = cg_Vertex + vec4(0.00000000E+000, float(_TMP12.w), 0.00000000E+000, 0.00000000E+000);
    _v0095 = vec4(_objectPosition0091.x, _objectPosition0091.y, _objectPosition0091.z, 1.00000000E+000);
    ...
    _v0108 = vec4(float(float(((_TMP8._colorSet0*_kTint)*2.00000000E+000).x)), float(float(((_TMP8._colorSet0*_kTint)*2.00000000E+000).y)), float(float(((_TMP8._colorSet0*_kTint)*2.00000000E+000).z)), float(float(((_TMP8._colorSet0*_kTint)*2.00000000E+000).w)));
